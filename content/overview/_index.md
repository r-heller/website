...
title: "Overview"
date: 2026-05-06
description: "Unified discovery network across publications, software, and courses."
---

A unified discovery network spanning publications, software, and courses.
Hover a node to inspect; click to follow. On small screens the graph is
hidden — the filtered list below is the canonical view.

<div id="ov-app" class="ov-page">
  <div class="ov-header">
    <input id="ov-search" class="ov-search" type="text"
           placeholder="Search publications, software, courses…" disabled>
    <div id="ov-type-chips" class="ov-type-chips" aria-hidden="true">
      ...
      <button class="ov-chip" type="button" disabled>▲ Courses</button>
    </div>
  </div>
  <div class="ov-body">
    ...
    <section class="ov-graph" aria-label="Network graph">
      ...
      <div id="ov-loading" class="placeholder">loading 631 nodes…</div>
  ...
  <div class="ov-stats">
    ...
    <span><strong id="ov-stat-course">…</strong> courses</span>
    <span style="margin-left:auto;font-family:var(--ov-mono);" id="ov-stat-edges">…</span>
  </div>
  <nav class="ov-lists" aria-label="All works">
    ...
    <section id="ov-col-course" class="ov-col" aria-labelledby="ov-col-course-heading">
      <h3 id="ov-col-course-heading">Courses <span class="count" id="ov-col-count-course">…</span></h3>
      <div class="ov-col-cards"></div>
    </section>
  </nav>
</div>
